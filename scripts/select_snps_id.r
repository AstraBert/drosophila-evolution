...
dfpool <- read.table("NoMAFData.diyabc.id", skip = 0, header = FALSE)
...
dfpool$sum12 <- dfpool$V2 + dfpool$V3
dfpool$sum34 <- dfpool$V4 + dfpool$V5
dfpool$sum56 <- dfpool$V6 + dfpool$V7
dfpool$sum78 <- dfpool$V8 + dfpool$V9
dfpool$sum91 <- dfpool$V10 + dfpool$V11
