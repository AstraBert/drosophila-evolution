...
ORIGIN_DIRS = ["drosophila-project/data/CN_XJ","drosophila-project/data/CnOther","drosophila-project/data/CnQTP","drosophila-project/data/ISR_1","drosophila-project/data/ISR_2"]

DESTINATION_DIR = "abertelli/drosophila-evolution/data"

for d in ORIGIN_DIRS:
    flnames = [f for f in os.listdir(d) if os.path.isdir(os.path.join(d,f))]
    filess = [os.path.join(DESTINATION_DIR,f) for f in os.listdir(DESTINATION_DIR) if f.split(".")[0] in flnames]
    c = 0
