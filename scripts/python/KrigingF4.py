...
df_pools = df_pools[((df_pools["Continent"] == "EU") | (df_pools["Continent"] == "AS")) & (df_pools["sampleId"] != "CnOther")]
...
plt.tight_layout()
plt.savefig(f"imgs/F4_wonorm_world.png", dpi=300, transparent=True)  # Save with transparent background
plt.show()
