...
if len(lines) < 15000:
	...
	first_block = lines[:17000]
	second_block = lines[-17000:]	
...
g.close()
sp.run("head -n 2 NoMAFData.diyabc > dts1/POOL_PopData_2.snp", shell=True)
sp.run("cat POOL_PopData_1a.txt >> dts1/POOL_PopData_2.snp", shell=True)
sp.run("head -n 2 NoMAFData.diyabc > dts2/POOL_PopData_3.snp", shell=True)
