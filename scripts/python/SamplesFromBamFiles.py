...
parser.add_argument(
    ...
    type=str,
    required=True,
    help="Input TXT file with a list of BAM files",
)
parser.add_argument(
    "-o", "--outputfile", type=str, required=True, help="Output samples file"
)
...
if __name__ == "__main__":
    ...
    for bamfile in bamfiles:
        ...
        print(
            f"Processed {bamfile}: found {samplename} as sample name", file=sys.stderr
        )
    outff.close()
    endt = time.time()
